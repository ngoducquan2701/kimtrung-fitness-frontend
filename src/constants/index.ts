export const testimonials = [
    ...
    {
        name: 'Phoebe',
        avatart: '/avatarTestimonials/phoebe.jpg',
        position: 'BUSINESS INVESTOR',
        content: ['Cuộc sống của tôi thay đổi tốt hơn rất nhiều sau 6 tháng tập luyện cùng Trung. Tôi vốn là người yếu đuối và hay bệnh tật, thân thể tôi có nhiều vấn đề, khi đi lại đầu gối tôi đau nhức. Điều đó ảnh hưởng đến công việc và sức khỏe của tôi rất tệ.', 'Anh ấy hỏi tôi vào ngày đầu tiên tôi quyết định đề nghị anh ấy trở thành PT của tôi: “tại sao tôi lại muốn tập thể dục?”, tôi nói rằng tôi cần sức khỏe tốt hơn.', 'Rồi bây giờ, đầu gối của tôi không còn đau nữa và sức khỏe của tôi cũng tốt hơn rất nhiều', 'Bên cạnh đó anh còn rèn cho tôi tính kỷ luật, trách nhiệm và tôn trọng thời gian sống của tôi. Rất nhiều giá trị tôi nhận được từ anh ấy.', 'Cảm ơn Kim Trung nhiều!', 'PT tuyệt vời mà tôi chưa từng gặp trước đây.']
    },
]
...
export const features = [
    {
        ...
        description: 'Giống như quần áo của bạn bè không vừa vặn với bạn, kế hoạch dinh dưỡng và tập luyện của họ cũng không phù hợp với bạn. Kế hoạch của chúng tôi được thực hiện cho nhu cầu cá nhân của bạn.'
    },
    {
        thumb: '/coaching/why-2.jpg',
        title: 'Xây dựng thói quen bền vững',
        description: 'Tập thể dục, khỏe đẹp là phần dễ, duy trì lâu dài mới là phần khó nhất, chúng tôi hiểu điều đó và tập trung dây dựng tư duy tập luyện, tạo động lực để bạn biến nó thành lối sống của mình.'
    },
    {
        thumb: '/coaching/why-3.jpg',
        title: 'Bất cứ lúc nào & ở đâu',
        description: 'Huấn luyện viên của bạn luôn ở bên cạnh bạn như một người hướng dẫn và giúp bạn định hướng hành trình tập luyện của mình. Tập luyện bất cứ nơi nào bạn muốn, có thể ở phòng tập hoặc từ ngôi nhà thoải mái của bạn.'
    },
]
